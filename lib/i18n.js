...
const de = {
  ...
  stayExtensionAverageRateLabel: "Ø Übernachtungspreis",
  stayExtensionPriceLabel: "Dein Verlängerungspreis",
  stayExtensionDiscountSuffix: "% Verlängerungsvorteil",
...
const en = {
  ...
  stayExtensionAverageRateLabel: "Average nightly rate",
  stayExtensionPriceLabel: "Your extension rate",
  stayExtensionDiscountSuffix: "% extension discount",
