...
const de = {
  ...
  // Shown directly under the accommodation line only — never implies the
  // discount applies to extras/city tax below it.
  stayExtensionDiscountSuffix: " % günstiger",
  stayExtensionAccommodationLabel: "Verlängerungsnacht",
  // Concatenated with the formatted saving amount: "Du sparst" + "25,05 €".
  stayExtensionSavingsLabel: "Du sparst",
...
const en = {
  ...
  stayExtensionSavingsLabel: "You save",
