...
const de = {
  ...
  // "DEIN GESAMTPREIS" — the prominent price is the guest's actual total
  // (accommodation after discount + any extras + city tax), not just the
  // discounted accommodation price on its own.
  stayExtensionPriceLabel: "DEIN GESAMTPREIS",
...
const en = {
  ...
  stayExtensionPriceLabel: "YOUR TOTAL PRICE",
