...
const de = {
  ...
  // Shown only on the compact, pre-arrival variant of the card (see
  // components/guest/GuestApp.jsx's StayExtensionCompactCard) — shorter,
  // more discreet than stayExtensionSubtitle above.
  ...
  // Only the compact pre-arrival card's EXPANDED confirmation button uses
  // this — the in-house card and the compact card's initial button both
  // keep stayExtensionButton above unchanged.
