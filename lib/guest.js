...
import { buildExtensionOffer, buildStayExtensionAmendmentPayload } from "./stayExtension.js";
import {
...
export async function getStayExtensionOffer(reservation) {
  try {
    ...
    return buildExtensionOffer({ reservation: fresh, timeSlices: fresh.timeSlices, gap, config });
  } catch (err) {
